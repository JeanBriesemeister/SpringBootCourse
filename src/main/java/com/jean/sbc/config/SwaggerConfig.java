...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.jean.sbc.resources")).paths(PathSelectors.any()).build()
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Jean Briesemeister", "jeanbr86@gmail.com", "jeanbr86@gmail.com"),
